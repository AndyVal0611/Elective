...
namespace Elective
{
    public class payrol_dbconnection
    {
        ...
        public void payrol_connString()
        {
            ...
            payrol_connectionString = "Data Source=192.168.1.100,41414;Initial Catalog=POSDB;User ID=Andyval0612;Password=Andyval0612;";
